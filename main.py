...
def main():
    # 输入总文件夹路径（包含多个论文子文件夹）
    root_folder = "test_outputs"  # ⚠️ 修改为你的实际路径
    ...
    for subdir in os.listdir(root_folder):
        ...
        # ===  Refiner  ===                
        refinement_ppt(input_index=auto_path, prompts=[commenter_prompt, reviser_prompt], model="gpt-4o", max_iterations=3)
        ...
        basic_information_path = extract_basic_information(dag_path=dag_path, auto_path=auto_path,extract_basic_information_prompt=extract_basic_information_prompt,model="gpt-4o-2024-11-20")
